    ...
    return (
        <div className="min-h-screen bg-slate-100 dark:bg-black flex items-center justify-center p-4">
            <Card className="w-full max-w-md border-0 shadow-lg bg-white dark:bg-slate-900">
                <CardHeader className="text-center space-y-4 pb-8 border-b border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/50">
                    <div className="mx-auto w-16 h-16 bg-slate-900 rounded-full flex items-center justify-center">
                        <ShieldCheck className="w-8 h-8 text-emerald-400" />
                    </div>
                    <div>
                        <CardTitle className="text-2xl font-bold tracking-tight text-slate-900 dark:text-white">SENTINEL</CardTitle>
                        <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Evidence Integrity System</p>
                    </div>
                </CardHeader>
                <CardContent className="pt-8">
                    <form onSubmit={handleLogin} className="space-y-4">
                        <div className="space-y-2">
                            <label className="text-sm font-medium text-slate-700 dark:text-slate-300">Badge ID</label>
                        ...
                        <div className="space-y-2">
                            <label className="text-sm font-medium text-slate-700 dark:text-slate-300">Secure Password</label>
                            <div className="relative">
